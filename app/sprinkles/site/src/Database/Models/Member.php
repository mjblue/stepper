...
use UserFrosting\Sprinkle\Site\Database\Models\MemberAux;
use UserFrosting\Sprinkle\Site\Database\Scopes\MemberAuxScope;
...
class Member extends User
{
    ...
    protected $fillable = [
        ...
        'password',
        'deleted_at',
        'cumulative_steps_total',
        'weekly_steps_total'
    ];

    protected $auxType = 'UserFrosting\Sprinkle\Site\Database\Models\MemberAux';
     ...
     */
    public function setCumulativeStepsAttribute($value)
    {
        $this->createAuxIfNotExists();

        $this->aux->cumulative_total_steps = $value;
    }

    /**
     * Custom mutator for Member property
     */
    public function setWeeklyStepsAttribute($value)
    {
        $this->createAuxIfNotExists();

        $this->aux->weekly_total_steps = $value;
    }
